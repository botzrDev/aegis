...
--
-- Columns hold schema-v1 audit fields only: no raw prompt/input/output text,
-- no agent or project identity. `embedding` is a deterministic, versioned
...
CREATE TABLE IF NOT EXISTS learning_patterns (
    ...
    audit_schema_version INTEGER NOT NULL CHECK (audit_schema_version = 1),
